...
async function cognitoValidateAccessToken(token, config) {
    const response = await fetch(`https://cognito-idp.${config.awsRegion}.amazonaws.com/${config.userPoolId}/.well-known/jwks.json`, { headers: { "Content-Type": "application/json" } });
